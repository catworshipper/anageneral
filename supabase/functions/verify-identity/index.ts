...
If this is not an ID document, return: {"error": "not_a_valid_id"}`,
    ...
    if (!extracted) {
      ...
      return new Response(
        JSON.stringify({
          success: false,
          error: 'We were unable to analyze your ID photo. This can happen with certain image types or lighting conditions. Please try again with a clearer, well-lit photo of your ID. If this persists, contact team@topwebweb.com.',
