...
INSERT INTO email_forwarding_config (address_prefix, forward_to, label, is_active) VALUES
  ...
  ('team', 'admin@topwebweb.com', 'Main inbox', true)
ON CONFLICT (address_prefix, forward_to) DO NOTHING;

-- Add comment to table
COMMENT ON TABLE email_forwarding_config IS 'Configuration for routing inbound emails received at @topwebweb.com to specific destinations';
